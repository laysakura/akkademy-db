...
import com.github.laysakura.akkademydb
import com.github.laysakura.akkademydb.annotations.VerboseServiceServer
import com.github.laysakura.akkademydb.idl.{VerboseService, VerboseService$FinagleClient}
...
object VerboseServiceModule extends TwitterModule {
  ...
  def provideVerboseService(
    ...
    @akkademydb.annotations.ClientId clientId: String
